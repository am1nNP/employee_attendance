  ...
  <table class="text-sm text-gray-500 w-full border">
          ...
          <tbody class="">
            ...
            if($rows->num_rows):
              ...
              <td class="w-auto py-6 px-4 whitespace-nowrap text-right"><a class="bg-[#d80032ad] text-white py-3 px-4 ring-2 ring-black rounded-md font-bold hover:bg-[#d80032]" href="./empDeleteAction.php?id=<?=$row['id']?>" >حذف</a></td>
            </tr>
            <?php
        endwhile;
    else:

  ...
  <table class="text-sm text-gray-500 w-full border">
          ...
          <tbody class="">
            ...
            if($rows->num_rows):
              ...
              <td class="w-auto py-6 px-4 whitespace-nowrap text-right"><a class="bg-[#0016d8ad] text-white py-3 px-4 ring-2 ring-black rounded-md font-bold hover:bg-[#0016d8e7]" href="./empEditForm.php?id=<?=$row['id']?>" >ویرایش</a></td>
            </tr>
            <?php
        endwhile;
    else:

  ...
  <table class="text-sm text-gray-500 w-full border">
          ...
          <tbody class="">
            ...
            if($rows->num_rows):
              ...
              <td class="w-auto py-6 px-4 whitespace-nowrap text-right"><a class="bg-[#009bd8ad] text-white py-3 px-4 ring-2 ring-black rounded-md font-bold hover:bg-[#00add8]" href="./empSetForm.php?id=<?=$row['id']?>" >حضور و غیاب</a></td>
            </tr>
            <?php
        endwhile;
    else:
